  ...
  if(isset($_GET['id'])){
    ...
    if(isset($_POST['submit'])){
      ...
      if(mysqli_num_rows($result) == 1){
        echo "<script>alert('The user has been used.')</script>";
        ...
        $sql_insert = "UPDATE users SET username = '$user', password = '$new' WHERE user_id = '$id'";
        ...
        <div class="login-form">
          <form action="<?= $_SERVER['PHP_SELF']."?id=".$_GET['id']?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  <input type="text" value="<?= $u?>" name="user" class="form-control" placeholder="Admin Username" required="required">
              </div>
              <div class="form-group">
